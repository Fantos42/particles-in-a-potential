...
param <- c(0,1) #slope, y-intercept initial values fit parameter, tdb
...
interval_fit <- c(1e2:1e3) # interval in which a straight line is fitted, tbd
...
plot(x=NA, y=NA, xlim=c(5e-5, 1e5), ylim = c(5e1, 1e5), log="xy")
