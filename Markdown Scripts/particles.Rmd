...
pdf("pairpotential_repulsion.pdf")
plot (x,  v1+v2, type='l', col='black', lwd=2, lty=1, ylim=c(ylow,yhigh), xlab='|r|', ylab='V')
lines(x,  v1   , type='l', col='red'  , lwd=2, lty=3)
lines(x,  v2   , type='l', col='blue' , lwd=2, lty=3)
abline(h=0)
legend(0.8, -2, legend=c("Pair Potential V", "Coulomb Repulsion", "Hard Shell"),col=c("black", "red", "blue"), lty=c(1,3,3))
dev.off()

pdf("pairpotential_attraction.pdf")
plot (x, -v1+v2, type='l', col='black', lwd=2, lty=1, ylim=c(ylow,yhigh), xlab='|r|', ylab='V')
lines(x, -v1   , type='l', col='red'  , lwd=2, lty=3)
lines(x,  v2   , type='l', col='blue' , lwd=2, lty=3)
abline(h=0)
legend(0.8, -2, legend=c("Pair Potential V", "Coulomb Attraction", "Hard Shell"),col=c("black", "red", "blue"), lty=c(1,3,3))
dev.off()
```
